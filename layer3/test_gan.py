...
def test_dataset_folders():
    """Verify DATA/real/ and DATA/gan_fake/ exist and contain JPEG files."""
    name = "test_dataset_folders"
    try:
        dataset_dir = _default_dataset_dir()
        real_dir = dataset_dir / "real"
        gan_dir = dataset_dir / "gan_fake"
...
def test_imagefolder_labels():
    ...
    try:
        ...
        train_loader, _, meta = mod.make_loaders(str(_default_dataset_dir()), device)
