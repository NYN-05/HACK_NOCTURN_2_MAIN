...
from ...application import RequestCache, VerificationOrchestrator
...
_request_cache = RequestCache(max(1, REQUEST_CACHE_MAX_ITEMS)) if ENABLE_REQUEST_CACHE else None
